...
#
# Examples:
# CHAIN_ID="localchain_9000-1" HOME_DIR="~/.rollchain" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="localchain_9000-2" HOME_DIR="~/.rollchain" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
from_scratch () {
  ...
  # roll1r6yue0vuyj9m7xw78npspt9drq2tmtvgf3rgys
