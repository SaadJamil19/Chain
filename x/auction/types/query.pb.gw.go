...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"auction", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Auction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 0, 1, 0, 4, 1, 5, 2}, []string{"auction", "v1", "auction_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Auctions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"auction", "v1", "auctions"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AuctionStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 0, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"auction", "v1", "auction_id", "status"}, "", runtime.AssumeColonVerbOpt(false)))
)
