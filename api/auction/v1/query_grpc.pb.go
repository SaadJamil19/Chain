...
const (
	...
	Query_Auction_FullMethodName       = "/auction.v1.Query/Auction"
	Query_Auctions_FullMethodName      = "/auction.v1.Query/Auctions"
	Query_AuctionStatus_FullMethodName = "/auction.v1.Query/AuctionStatus"
)
...
func (c *queryClient) AuctionStatus(ctx context.Context, in *QueryAuctionStatusRequest, opts ...grpc.CallOption) (*QueryAuctionStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_AuctionStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) AuctionStatus(context.Context, *QueryAuctionStatusRequest) (*QueryAuctionStatusResponse, error) {
...
func _Query_AuctionStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_AuctionStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
