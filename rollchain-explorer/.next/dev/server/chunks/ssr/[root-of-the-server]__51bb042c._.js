...
"[project]/config/tokens.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$tokens$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/config/tokens.ts [ssr] (ecmascript)");
;
;
;
;
...
;
// ═══════════════ CONSTANTS ═══════════════
const RPC_ENDPOINT = process.env.NEXT_PUBLIC_RPC || 'http://5.189.162.146:26757';
...
function useRollchainClient() {
    ...
    const [tokenMarkets, setTokenMarkets] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$config$2f$tokens$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["TRACKED_TOKENS"].map((token, index)=>({
            ...token,
            price: null,
            rawPrice: null,
            source: undefined,
    ...
    const loadTokenMarkets = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])(async ()=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$config$2f$tokens$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["TRACKED_TOKENS"].length) return;
        const restBase = sanitizeRestBase(REST_ENDPOINT);
        const updates = await Promise.all(__TURBOPACK__imported__module__$5b$project$5d2f$config$2f$tokens$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["TRACKED_TOKENS"].map(async (token)=>{
            try {
        ...
        setTokenMarkets((prev)=>updates.map((update)=>{
                const previous = prev.find((p)=>p.symbol === update.token.symbol);
        ...
        const bootstrap = async ()=>{
            try {
                ...
                timer = setInterval(()=>{
                    ...
                    loadTokenMarkets().catch(()=>undefined);
                }, SIX_SECONDS);
            } catch (err) {
...
function NavBar() {
    ...
    const [networkTab, setNetworkTab] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])('mainnet');
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__51bb042c._.js.map