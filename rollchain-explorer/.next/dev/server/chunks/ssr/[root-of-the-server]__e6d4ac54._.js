...
(()=>{
    const e = new Error("Cannot find module '@cosmjs/rpc-client'");
...
function useRollchainClient() {
    ...
    const hydrateTmClient = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])(async ()=>{
        ...
        tmRef.current = await Tendermint34Client.connect({
            url: RPC_ENDPOINT
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e6d4ac54._.js.map